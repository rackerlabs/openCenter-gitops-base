locals {
  ...
  ansible_hardening_version                  = "stable/2025.1"
...
module "openstack-nova" {
  source = "../../../../openCenter/install/iac/infra/openstack-nova"
...
module "kubespray-cluster" {
  ...
  source = "../../../../openCenter/install/iac/kubespray"
  address_bastion                         = module.openstack-nova.bastion_floating_ip
  ansible_hardening_version               = local.ansible_hardening_version 
...
module "calico" {
  source = "../../../../openCenter/install/iac/calico"
